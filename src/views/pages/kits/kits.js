...
const Kits = () =>{
  ...
  const goToCreateKit = ()  =>{
    ...
    return (
        <div className="row">
            ...
            <StyledTitleStart>Meus Kits</StyledTitleStart>
            <button onClick={()=>goToCreateKit()} className="btn btn-warning mx-1"><i class="bi bi-box"></i></button>
            </div>
 ...
 <option >id ordem decrecente</option> 
      ...
      <Table striped bordered hover variant="dark">
        ...
        <tbody>
          <tr>
            <td colSpan="8" className="text-center">Nenhuma kit encontrado</td>
          </tr>
        </tbody>
      </Table>
    </div>
